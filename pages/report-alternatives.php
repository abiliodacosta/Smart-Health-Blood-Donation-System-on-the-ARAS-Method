...
$stmt = $pdo->query("SELECT * FROM alternatives WHERE is_ideal = 0 ORDER BY code ASC");
$alternatives = $stmt->fetchAll();

$page_title = "Relatorio Alternativu - CVTL DSS";
$current_page = "report_alternatives";
include '../templates/header.php';
include '../templates/sidebar.php';
?>

<div class="d-sm-flex align-items-center justify-content-between mb-4 d-print-none">
    <h1 class="h3 mb-0 text-gray-800">Relatorio Alternativu</h1>
    <div class="mt-3 mt-sm-0">
        <div class="btn-group shadow-sm w-100">
            ...
            <button onclick="exportTableToExcel('altTableContent', 'Relatorio_Alternativu')" class="btn btn-success">
                <i class="fas fa-file-excel fa-sm"></i> <span class="d-none d-md-inline ml-1">Excel</span>
            </button>
            <button onclick="exportTableToWord('altTableContent', 'Relatorio_Alternativu')" class="btn btn-info">
...
<div id="altTableContent">
<div class="card shadow mb-4 print-content" id="altTable">
    <div class="card-body">
        <!-- Report Header -->
        <div class="text-center mb-5">
            ...
            <h5 class="font-weight-bold text-uppercase">Relatorio Dadus Alternativu</h5>
            ...
            <table class="table table-bordered table-striped" width="100%" cellspacing="0">
                <thead class="bg-light text-dark text-center">
                    <tr>
                        <th width="5%">No</th>
                        <th width="10%">Kodu</th>
                        <th width="25%">Naran Alternativu</th>
                        <th width="10%">Sexu</th>
                        <th width="10%">Tinan</th>
                        <th width="20%">Hela Fatin</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center"><strong><?php echo $alt['code']; ?></strong></td>
                            <td><?php echo $alt['name']; ?></td>
                            <td class="text-center"><?php echo $alt['sexu']; ?></td>
                            <td class="text-center"><?php echo $alt['tinan']; ?></td>
                            <td><?php echo $alt['hela_fatin']; ?></td>
                            <td class="text-center"><?php echo $alt['telefone']; ?></td>
                            <td class="text-center"><span class="badge badge-danger"><?php echo $alt['tipu_ran']; ?></span></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
